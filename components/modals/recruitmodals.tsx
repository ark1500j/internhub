...
export const RecruitSignUpModal = ({ isModalOpen, handleCloseModal,email }: Props) => {
  const [otp,setOtp]= useState("")
  const router= useRouter()
    async function handleVerify() {
      const res = await otpVerifyAction(email,otp,"recruit")
...
export const RecruitSignInModal = ({ isModalOpen, handleCloseModal,email }: Props) => {
  const [otp,setOtp]=useState("")
  const router= useRouter()
    async function handleVerify() {
      const res = await otpVerifyAction(email,otp,"recruit")
